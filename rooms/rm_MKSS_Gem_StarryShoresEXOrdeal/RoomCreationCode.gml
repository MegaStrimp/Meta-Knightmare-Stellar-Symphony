...
#region Begin Stage
if (!global.inStage) scr_MKSS_Stage_Begin("starryShoresOrdealEX");
#endregion
...
#region Stage Intro
scr_MKSS_UI_GemIntro_Create("Enemy Ordeal","Starry Shores EX","Defeat Waves of Enemies",global.MKSS_StageIDs[? "starryShoresOrdealEX"]);
#endregion

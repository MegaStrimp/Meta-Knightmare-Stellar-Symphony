...
#region Begin Stage
if (global.roomPrevious != room) scr_MKSS_Stage_Begin("gemArena1EX");
#endregion
...
#region Stage Intro
scr_MKSS_UI_GemIntro_Create("Enemy Ordeal","Starry Shores EX","Defeat Waves of Enemies",global.MKSS_StageIDs[? "gemArena1EX"]);
#endregion

...
#region Begin Stage
if (global.roomPrevious != room) scr_MKSS_Stage_Begin("gemArena2");
#endregion
...
#region Stage Intro
scr_MKSS_UI_GemIntro_Create("Enemy Ordeal","Royal Reeve","Defeat Waves of Enemies",global.MKSS_StageIDs[? "gemArena2"],spr_MKSS_UI_Decal_Pal_RoyalReeve);
#endregion

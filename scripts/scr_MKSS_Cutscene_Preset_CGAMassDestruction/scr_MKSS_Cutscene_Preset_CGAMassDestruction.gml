///@description MKSS - Cutscene - Preset - CGA Mass Destruction

function scr_MKSS_Cutscene_Preset_CGAMassDestruction()
{
	#region Setup
	canBePaused = false;
	#endregion
	...
	[
		function()
		{
			...
			//with (obj_MKSS_Enemy_CGA)
			//{
			//	scr_Enemy_ChangeState_Step(id,scr_MKSS_Enemy_obj_MKSS_Enemy_CGA_AI_Cutscene_SOMETHING_Step);
			//}

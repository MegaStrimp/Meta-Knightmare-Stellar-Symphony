///@description MKSS - Enemy - Chasse Emee - AI - Normal - Slash Combo - Step

function scr_MKSS_Enemy_ChasseEmee_AI_Normal_SlashCombo_Step()
{
	#region Setup
	if (enemyState_Setup)
	{
		#region Attack Init
		attackString = "Chasse Emee - Slash Combo";

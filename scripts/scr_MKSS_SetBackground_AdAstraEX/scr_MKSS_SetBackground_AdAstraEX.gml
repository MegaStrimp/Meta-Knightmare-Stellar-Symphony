///@description MKSS - Set Background - Ad Astra EX

function scr_MKSS_SetBackground_AdAstraEX()
{
	if (backgroundSetup)
	{
		...
		backgroundIndex[arrayIndex] = layer_background_create(backgroundLayer[arrayIndex],bg_MKSS_AdAstraEX);
	...
	var bgWidth = sprite_get_width(bg_MKSS_AdAstraEX);

...
function scr_MKSS_Player_BeginStep_Main()
{
	...
	else if (position_meeting(bbox_right - 1,bbox_bottom + dirY,obj_Wall))
	{
		collidingWall = instance_place(bbox_right - 1,bbox_bottom + dirY,obj_Wall);
	}
	...
	else if (position_meeting(x,bbox_bottom + dirY,obj_Platform))
	{
		var collidingWall = instance_place(x,bbox_bottom + dirY,obj_Platform);

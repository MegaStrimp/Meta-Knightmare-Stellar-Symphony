///@description MKSS - Attack - Execute - Buzzcut - Slash1

function scr_MKSS_Attack_Execute_Buzzcut_Slash1()
{
	...
	with (instance_create_depth(x,y,depth - 1,obj_MKSS_Attack))
	{
		...
		enemyHitBehavior = scr_MKSS_Attack_Buzzcut_Slash1_EnemyHitBehavior;

///@description MKSS - Cutscene - Preset - Chasse Mass Destruction

function scr_MKSS_Cutscene_Preset_ChasseMassDestruction()
{
	#region Setup
	canBePaused = false;
	#endregion
	...
	[
		function()
		{
			...
			//{
			//	scr_Enemy_ChangeState_Step(id,scr_MKSS_Enemy_obj_MKSS_Enemy_ChasseEmee_AI_Cutscene_SOMETHING_Step);
			//}

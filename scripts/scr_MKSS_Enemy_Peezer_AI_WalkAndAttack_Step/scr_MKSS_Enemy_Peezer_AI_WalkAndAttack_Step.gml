///@description MKSS - Enemy - Peezer - AI - Walk and Attack - Step

function scr_MKSS_Enemy_Peezer_AI_WalkAndAttack_Step()
{
	if (!localPause)
	{
		...
		if (attackTimer != -1)
		{
			...
			if (attackTimer == 0)
			{
				...
				switch (attackState)
				{
					...
					attackIndex = global.MKSS_AttackIDs[? "peezer_Claw"];

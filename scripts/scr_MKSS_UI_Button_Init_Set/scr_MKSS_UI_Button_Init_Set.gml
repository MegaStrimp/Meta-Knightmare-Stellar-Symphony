...
function scr_MKSS_UI_Button_Init_Set()
{
	...
	if (global.isOpera)
	{
		...
		scr_MKSS_UI_Button_Init_Add_Neighbors(targetMappedID_Discord,targetMappedID_Github,targetMappedID_Twitter,targetMappedID_Save3,targetMappedID_Save1);
		...
		scr_MKSS_UI_Button_Init_Add_Neighbors(targetMappedID_Github,targetMappedID_Twitter,targetMappedID_Discord,targetMappedID_Save3,targetMappedID_Save1);
	}
	else
	{
		var targetMappedID_Save1 = scr_MKSS_UI_Button_Init_Add("save1",spr_MKSS_Menu_TitleScreen_Button_Save1,scr_MKSS_UI_Button_Save1_Create,scr_MKSS_UI_Button_Save1_Trigger,scr_MKSS_UI_Button_Save1_Base,scr_MKSS_UI_Button_Save1_Draw);

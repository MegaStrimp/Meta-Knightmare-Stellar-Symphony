...
function scr_MKSS_Weapon_Init_Set()
{
	...
	scr_MKSS_Weapon_Init_Add_SpriteSet(targetMappedID,
	{
		...
		sprUpDuck: spr_MKSS_Player_MetaKnight_Normal_Sword_Galaxia_UpDuck,
		sprSquish: spr_MKSS_Player_MetaKnight_Normal_Sword_Galaxia_Squish,
		...
		sprDoorEnter: spr_MKSS_Player_MetaKnight_Normal_Sword_Galaxia_DoorEnter,
		sprFront: undefined,
		sprFallen: undefined,
		sprHurtNormal: spr_MKSS_Player_MetaKnight_Normal_Sword_Galaxia_Hurt_Normal,
		sprHurtShocked: spr_MKSS_Player_MetaKnight_Normal_Sword_Galaxia_Hurt_Shocked,
		sprHurtBurned: spr_MKSS_Player_MetaKnight_Normal_Sword_Galaxia_Hurt_Burned,
		sprHurtFrozen: spr_MKSS_Player_MetaKnight_Normal_Sword_Galaxia_Hurt_Frozen,
	...
	scr_MKSS_Weapon_Init_Add_SpriteSet(targetMappedID,
	{
		...
		sprUpDuck: spr_MKSS_Player_MetaKnight_Normal_Sword_Buzzcut_UpDuck,
		sprSquish: spr_MKSS_Player_MetaKnight_Normal_Sword_Buzzcut_Squish,
		...
		sprDoorEnter: spr_MKSS_Player_MetaKnight_Normal_Sword_Buzzcut_DoorEnter,
		sprFront: undefined,
		sprFallen: undefined,

///@description MKSS - Set Background - Royal Reeve EX

function scr_MKSS_SetBackground_RoyalReeveEX()
{
	if (backgroundSetup)
	{
		...
		backgroundIndex[arrayIndex] = layer_background_create(backgroundLayer[arrayIndex],bg_MKSS_RoyalReeveEX);
	...
	var bgWidth = sprite_get_width(bg_MKSS_RoyalReeveEX);

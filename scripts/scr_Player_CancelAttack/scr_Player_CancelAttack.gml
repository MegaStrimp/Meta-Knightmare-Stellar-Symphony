...
function scr_Player_CancelAttack(targetPlayer,targetAttack)
{
	with (targetPlayer)
	{
		...
		if ((canAttackCancelTargetState) and (attackCancelTargetState != -1)) scr_Player_ChangePlayerState_Step(id,attackCancelTargetState);
		canAttackCancelTargetState = true;

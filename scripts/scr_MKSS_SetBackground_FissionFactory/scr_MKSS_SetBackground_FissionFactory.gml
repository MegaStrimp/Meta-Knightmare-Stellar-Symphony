///@description MKSS - Set Background - Fission Factory

function scr_MKSS_SetBackground_FissionFactory()
{
	if (backgroundSetup)
	{
		...
		backgroundIndex[arrayIndex] = layer_background_create(backgroundLayer[arrayIndex],bg_MKSS_FissionFactory);
	...
	var bgWidth = sprite_get_width(bg_MKSS_FissionFactory);

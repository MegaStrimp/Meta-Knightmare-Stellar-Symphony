///@description MKSS - Cutscene - Preset - Starless Nebula Mass Destruction

function scr_MKSS_Cutscene_Preset_StarlessNebulaMassDestruction()
{
	#region Setup
	canBePaused = false;
	#endregion
	...
	[
		function()
		{
			...
			//with (obj_MKSS_Enemy_StarlessNebula)
			//{
			//	scr_Enemy_ChangeState_Step(id,scr_MKSS_Enemy_obj_MKSS_Enemy_StarlessNebula_AI_Cutscene_SOMETHING_Step);
			//}

///@description MKSS - Cutscene - Preset - Starless Zero Two Mass Destruction

function scr_MKSS_Cutscene_Preset_StarlessZeroTwoMassDestruction()
{
	#region Setup
	canBePaused = false;
	#endregion
	...
	[
		function()
		{
			...
			//with (obj_MKSS_Enemy_StarlessZeroTwo)
			//{
			//	scr_Enemy_ChangeState_Step(id,scr_MKSS_Enemy_obj_MKSS_Enemy_StarlessZeroTwo_AI_Cutscene_SOMETHING_Step);
			//}

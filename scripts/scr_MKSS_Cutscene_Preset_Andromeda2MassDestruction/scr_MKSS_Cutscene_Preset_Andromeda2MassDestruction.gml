///@description MKSS - Cutscene - Preset - Andromeda 2 Mass Destruction

function scr_MKSS_Cutscene_Preset_Andromeda2MassDestruction()
{
	#region Setup
	canBePaused = false;
	#endregion
	...
	[
		function()
		{
			...
			//with (obj_MKSS_Enemy_Andromeda2)
			//{
			//	scr_Enemy_ChangeState_Step(id,scr_MKSS_Enemy_obj_MKSS_Enemy_Andromeda2_AI_Cutscene_SOMETHING_Step);
			//}

...
function scr_MKSS_Upgrade_Init_Set()
{
	...
	var targetMappedID_Galaxia_ExtraFinisher = scr_MKSS_Upgrade_Init_Add("Galaxia_ExtraFinisher",categoryID,99,66);
	...
	var targetMappedID_Galaxia_MachPrime = scr_MKSS_Upgrade_Init_Add("Galaxia_MachPrime",categoryID,145,88);
	...
	var targetMappedID_Galaxia_BlastPound = scr_MKSS_Upgrade_Init_Add("Galaxia_BlastPound",categoryID,108,36);
	...
	var targetMappedID_Buzzcut_Overcharge = scr_MKSS_Upgrade_Init_Add("Buzzcut_Overcharge",categoryID,77,61);
	...
	scr_MKSS_Upgrade_Init_Add_Info(targetMappedID_Buzzcut_SawBombard,"SawBombard");
	
	var targetMappedID_Buzzcut_ChainChakram = scr_MKSS_Upgrade_Init_Add("Buzzcut_ChainChakram",categoryID,160,51);
	scr_MKSS_Upgrade_Init_Add_Info(targetMappedID_Buzzcut_ChainChakram,"ChainChakram");
	#endregion
	...
	#region Neighbor Setup
	scr_MKSS_Upgrade_Init_Add_Neighbors(targetMappedID_Buzzcut_Finisher,targetMappedID_Buzzcut_Lesser1);
	#endregion
	#endregion

///@description MKSS - Set Background - Fission Factory EX

function scr_MKSS_SetBackground_FissionFactoryEX()
{
	if (backgroundSetup)
	{
		...
		backgroundIndex[arrayIndex] = layer_background_create(backgroundLayer[arrayIndex],bg_MKSS_FissionFactoryEX);
	...
	var bgWidth = sprite_get_width(bg_MKSS_FissionFactoryEX);

///@description MKSS - Particle Set - Metal Block Break

function scr_MKSS_ParticleSet_MetalBlockBreak(parTargetX,parTargetY)
{
	...
	for (var i = 0; i < pieceCount; i++)
	{
		...
		par[i + 1].sprite_index = spr_MKSS_Particle_MetalBlockPiece;

...
function scr_MKSS_Music_Init_Set()
{
	...
	scr_MKSS_Music_Init_Add("starryShores","It's Going Down Now","Persona 3 Reload",mus_MKSS_StarryShores,11.398,[114]);
	...
	scr_MKSS_Music_Init_Add("starryShoresEX","Don't","Persona 3 Reload",mus_MKSS_StarryShoresEX,.491,[106.569]);

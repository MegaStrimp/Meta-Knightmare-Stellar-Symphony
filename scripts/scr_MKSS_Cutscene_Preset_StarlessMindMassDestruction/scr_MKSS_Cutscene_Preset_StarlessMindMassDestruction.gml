///@description MKSS - Cutscene - Preset - Starless Mind Mass Destruction

function scr_MKSS_Cutscene_Preset_StarlessMindMassDestruction()
{
	#region Setup
	canBePaused = false;
	#endregion
	...
	[
		function()
		{
			...
			//with (obj_MKSS_Enemy_StarlessMind)
			//{
			//	scr_Enemy_ChangeState_Step(id,scr_MKSS_Enemy_obj_MKSS_Enemy_StarlessMind_AI_Cutscene_SOMETHING_Step);
			//}

///@description MKSS - Set Background - Living Loom

function scr_MKSS_SetBackground_LivingLoom()
{
	if (backgroundSetup)
	{
		...
		backgroundIndex[arrayIndex] = layer_background_create(backgroundLayer[arrayIndex],bg_MKSS_LivingLoom);
	...
	var bgWidth = sprite_get_width(bg_MKSS_LivingLoom);

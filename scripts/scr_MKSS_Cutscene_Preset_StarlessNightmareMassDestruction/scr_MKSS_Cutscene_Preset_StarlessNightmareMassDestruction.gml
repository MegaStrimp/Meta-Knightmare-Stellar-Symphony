///@description MKSS - Cutscene - Preset - Starless Nightmare Mass Destruction

function scr_MKSS_Cutscene_Preset_StarlessNightmareMassDestruction()
{
	#region Setup
	canBePaused = false;
	#endregion
	...
	[
		function()
		{
			...
			//{
			//	scr_Enemy_ChangeState_Step(id,scr_MKSS_Enemy_obj_MKSS_Enemy_StarlessNightmare_AI_Cutscene_SOMETHING_Step);
			//}

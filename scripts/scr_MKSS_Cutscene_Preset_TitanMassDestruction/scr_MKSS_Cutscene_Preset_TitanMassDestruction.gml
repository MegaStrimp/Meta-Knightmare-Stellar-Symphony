///@description MKSS - Cutscene - Preset - Titan Mass Destruction

function scr_MKSS_Cutscene_Preset_TitanMassDestruction()
{
	#region Setup
	canBePaused = false;
	#endregion
	...
	[
		function()
		{
			...
			//with (obj_MKSS_Enemy_Titan)
			//{
			//	scr_Enemy_ChangeState_Step(id,scr_MKSS_Enemy_obj_MKSS_Enemy_Titan_AI_Cutscene_SOMETHING_Step);
			//}

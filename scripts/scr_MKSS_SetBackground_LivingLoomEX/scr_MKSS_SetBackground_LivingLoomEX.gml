///@description MKSS - Set Background - Living Loom EX

function scr_MKSS_SetBackground_LivingLoomEX()
{
	if (backgroundSetup)
	{
		...
		backgroundIndex[arrayIndex] = layer_background_create(backgroundLayer[arrayIndex],bg_MKSS_LivingLoomEX);
	...
	var bgWidth = sprite_get_width(bg_MKSS_LivingLoomEX);

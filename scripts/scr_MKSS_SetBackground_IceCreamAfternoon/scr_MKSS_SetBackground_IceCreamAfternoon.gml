///@description MKSS - Set Background - Ice Cream Afternoon

function scr_MKSS_SetBackground_IceCreamAfternoon()
{
	if (backgroundSetup)
	{
	...
	var bgWidth = sprite_get_width(bg_MKSS_IceCreamAfternoon);

///@description MKSS - Cutscene - Preset - Starless Dedede Mass Destruction

function scr_MKSS_Cutscene_Preset_StarlessDededeMassDestruction()
{
	#region Setup
	canBePaused = false;
	#endregion
	...
	[
		function()
		{
			...
			//with (obj_MKSS_Enemy_StarlessDedede)
			//{
			//	scr_Enemy_ChangeState_Step(id,scr_MKSS_Enemy_obj_MKSS_Enemy_StarlessDedede_AI_Cutscene_SOMETHING_Step);
			//}

///@description MKSS - Particle Set - Door Star - Yellow 1

function scr_MKSS_ParticleSet_DoorStar_Yellow1(parTargetX,parTargetY,parTargetDir)
{
	...
	par[0].particleAfterDeath[0] = scr_MKSS_ParticleSet_DoorStar_Yellow2;

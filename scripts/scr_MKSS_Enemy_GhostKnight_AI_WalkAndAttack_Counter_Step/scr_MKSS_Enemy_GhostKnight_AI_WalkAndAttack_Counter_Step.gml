///@description MKSS - Enemy - Ghost Knight - AI - Walk and Attack - Counter - Step

function scr_MKSS_Enemy_GhostKnight_AI_WalkAndAttack_Counter_Step()
{
	#region Setup
	if (enemyState_Setup)
	{
		#region Attack Init
		attackString = "Ghost Knight - Counter";
	...
	if (!localPause)
	{
		...
		switch (attackState)
		{
			...
			if (attackStateTimer[attackState] == -1)
			{
				...
				attackIndex = global.MKSS_AttackIDs[? "ghostKnight_Counter"];
				...
				with (instance_create_depth(x,y,depth,obj_MKSS_Attack))
				{
					...
					attackAIEndStep = scr_MKSS_Attack_GhostKnight_Counter_EndStep;
				}
				#endregion

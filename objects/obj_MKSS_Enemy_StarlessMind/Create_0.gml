...
enemyID = global.MKSS_EnemyIDs[? "starlessMind"];
...
[
	function()
	{
		scr_MKSS_Enemy_StarlessMind_Normal_AttackOrder_Phase2();
	}
];

massDestructionScript = scr_MKSS_Cutscene_Preset_StarlessMindMassDestruction;
#endregion

...
{
	#region Categories
	scr_Settings_Init_Add("display","Display",,,scr_Settings_Component_LoadPage,[scr_Settings_PageSetup_Display],scr_MKSS_Settings_Component_GoToPause);
	scr_Settings_Init_Add("audio","Audio",,,scr_Settings_Component_LoadPage,[scr_Settings_PageSetup_Audio],scr_MKSS_Settings_Component_GoToPause);
	scr_Settings_Init_Add("controls","Controls",,,scr_Settings_Component_LoadPage,[scr_Settings_PageSetup_Controls],scr_MKSS_Settings_Component_GoToPause);
	#endregion

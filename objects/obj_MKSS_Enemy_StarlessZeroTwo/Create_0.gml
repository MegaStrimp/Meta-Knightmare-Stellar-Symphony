...
enemyID = global.MKSS_EnemyIDs[? "starlessZeroTwo"];
...
[
	function()
	{
		scr_MKSS_Enemy_StarlessZeroTwo_Normal_AttackOrder_Phase2();
	}
];

massDestructionScript = scr_MKSS_Cutscene_Preset_StarlessZeroTwoMassDestruction;
#endregion

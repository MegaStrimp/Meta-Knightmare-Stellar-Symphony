...
enemyID = global.MKSS_EnemyIDs[? "starlessNebula"];
...
[
	function()
	{
		scr_MKSS_Enemy_StarlessNebula_Normal_AttackOrder_Phase2();
	}
];

massDestructionScript = scr_MKSS_Cutscene_Preset_StarlessNebulaMassDestruction;
#endregion

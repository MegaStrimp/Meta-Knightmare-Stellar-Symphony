...
enemyID = global.MKSS_EnemyIDs[? "starlessDedede"];
...
[
	function()
	{
		scr_MKSS_Enemy_StarlessDedede_Normal_AttackOrder_Phase2();
	}
];

massDestructionScript = scr_MKSS_Cutscene_Preset_StarlessDededeMassDestruction;
#endregion
